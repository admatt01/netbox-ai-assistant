...
if not st.session_state.thread_id:
    ...
    intro_message = "Hello! I'm your Netbox AI Assistant. You can ask me about IP addresses, devices, interfaces, locations and more. How can I help you with Netbox today?"
